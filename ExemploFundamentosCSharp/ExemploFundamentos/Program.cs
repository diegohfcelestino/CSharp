using ExemploFundamentosCSharp.Common.Models;
...
{
  Console.Write($"Posição N° {contador} - {listaString[contador]} \n");
}

int contaforForeach = 0;
foreach (string item in listaString)
{
  Console.Write($"Posição N° {contaforForeach} - {listaString[contaforForeach]} \n");
  contaforForeach++;
}
